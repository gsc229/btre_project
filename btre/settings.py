...
AWS_ACCESS_KEY_ID = os.getenv('AMZWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.getenv('AMZWS_SECRET_ACCESS_KEY')
AWS_S3_SIGNATURE_VERSION = os.getenv('AMZWS_S3_SIGNATURE_VERSION')
AWS_DEFAULT_REGION = os.getenv('AMZWS_DEFAULT_REGION')
AWS_STORAGE_BUCKET_NAME = os.getenv('AMZWS_STORAGE_BUCKET_NAME')
